...
<%@ include file = "../header.jsp" %>
	...
	<div class="container">
	  ...
	  <form class ="form_rvwrite" name="form_rvwrite" method="post" enctype="multipart/form-data" action="review_modifypro.do" onsubmit="return check()">
			...
			<table class="rv_write_table">
				...
				<tbody>
					<tr>
						...
						<input type="text" name="writer" value="${modify.writer }" class="rv_writer"></td>
					</tr>
					<tr>
						<!-- <th>제목</th> -->
						<td><input type="text" name="title" value="${modify.title } " class="rv_title"></td>
					</tr>
					<tr>
						<!-- <th>내용</th> -->
